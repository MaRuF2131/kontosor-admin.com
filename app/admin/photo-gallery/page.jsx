...
import PhotoGalleryList from "@/components/admin/PhotoGalleryList";
...
export default function PhotoStoryListPage() {
  ...
  const handleDelete = (id) => {
    confirmDelete(() => {
      D.mutate({
        url: `/admin/${id}?database=photo_gallery`,
        query: {
          url: "/admin/photo_gallery",
          search: debouncedSearchTerm || '',
          status: filterStatus || 'all',
